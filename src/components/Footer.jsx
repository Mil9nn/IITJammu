                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-4 mb-4">
                            <a href="https://www.facebook.com/IITJammuOfficial/" className="bg-[#007fc6] hover:bg-[#0e6496] p-2 rounded-full transition-colors duration-300">
                            ...
                            <a href="https://www.instagram.com/iit.jammu/" className="bg-[#007fc6] hover:bg-[#0e6496] p-2 rounded-full transition-colors duration-300">
                                <div className="w-5 h-5 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
                            ...
                            <a href="https://www.linkedin.com/school/iitjammu/" className="bg-[#007fc6] hover:bg-[#0e6496] p-2 rounded-full transition-colors duration-300">
                                <div className="w-5 h-5 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
                        ...
                        <div className="text-sm text-blue-200">
                            ...
                            <p className="mb-2">Email: info@university.edu</p>
                            <p>Main Office: +91 44 2257 0000</p>
                        </div>
                    </div>
                </div>
