              ...
              <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-[#39a4cf]">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Compassion:</strong> Treating each individual with kindness, dignity, and respect
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#39a4cf] mr-2 mt-1 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <span>
                      <strong>Excellence:</strong> Maintaining the highest standards of professional care
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#39a4cf] mr-2 mt-1 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <span>
                      <strong>Accessibility:</strong> Ensuring care is available to all members of our community
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#39a4cf] mr-2 mt-1 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <span>
                      <strong>Confidentiality:</strong> Respecting privacy and maintaining trust
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <div className="py-16 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Our modern healthcare center is equipped with state-of-the-art facilities to provide comprehensive care to all members of the IIT Jammu community.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 flex flex-col">
              ...
              <div className="p-6 flex-grow">
                ...
                <p className="text-gray-600">Comfortable, soundproof rooms designed for confidential medical consultations and therapy sessions.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 flex flex-col">
              <div className="h-48 overflow-hidden">
                <img className="w-full h-full object-cover transition-transform duration-500 hover:scale-105" src="/images/emergency-care.webp" alt="Emergency Care" />
              </div>
              <div className="p-6 flex-grow">
                <div className="flex items-center mb-3">
                  <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
                  ...
                  <h3 className="font-bold text-xl text-gray-800">Emergency Care</h3>
                </div>
                <p className="text-gray-600">A dedicated Wellness Center offering professional counseling, mental health support, stress management, and holistic well-being services to promote a healthier lifestyle.</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 flex flex-col">
              ...
              <div className="p-6 flex-grow">
                ...
                <p className="text-gray-600">State-of-the-art telehealth equipment for remote consultations with specialists and after-hours support.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">What members of the IIT Jammu community say about our healthcare services</p>
          </div>
